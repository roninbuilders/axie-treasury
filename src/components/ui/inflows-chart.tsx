	...
	return (
		<Card className="flex flex-col">
			...
			<CardContent className="flex-1 pb-0">
				<ChartContainer config={chartConfig} className="mx-auto aspect-square max-h-[250px]">
					<PieChart>
						...
						<Pie data={chartData} dataKey="inflows" nameKey="browser" innerRadius={60} strokeWidth={5}>
							<Label
								content={({ viewBox }) => {
			...
			<CardFooter className="flex-col gap-2 text-sm">
				<div className="leading-none text-muted-foreground">Showing total inflows for the last 3 months</div>
			</CardFooter>
		</Card>
	)
}
